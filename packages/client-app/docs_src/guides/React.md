...
The Nylas Mail interface is composed at runtime from components added by different packages. The app's left sidebar contains components from the composer package, the source list package, the activity package, and more. You can leverage the flexibility of this system to extend almost any part of Nylas Mail's interface.
...
<img src="/img/injected-components.png">
...
<img src="/img/unsafe-component-exception.png">
